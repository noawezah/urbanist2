...
export const metadata = { title: 'Food & Drinks Menu — The Urbanist, Bucharest', description: 'Explore specialty coffee, breakfast, mains, cocktails and more at The Urbanist. Prices, ingredients, portions and allergen details.' };
