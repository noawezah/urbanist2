...
export default function PreviewMotion() {
 useEffect(() => {
  ...
  media.add('(prefers-reduced-motion: no-preference)', () => {
   ...
   gsap.utils.toArray<HTMLElement>('[data-wall-parallax]').forEach(image => gsap.fromTo(image, { yPercent: -8 }, { yPercent: 8, ease: 'none', scrollTrigger: { trigger: image.closest('.menu-wall'), start: 'top bottom', end: 'bottom top', scrub: 1 } }));
